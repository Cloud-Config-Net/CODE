    ...
    <div class="w-full max-w-5xl my-auto py-8 z-10 relative">
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-6 glass-panel p-6 rounded-2xl relative overflow-hidden">
            ...
            <div class="flex flex-row gap-4 z-10 justify-center md:justify-end mt-6 md:mt-0">
                <a href="javascript:history.back()" title="Back" class="bg-[#0d131f] hover:bg-[#151e2e] border border-[#1e2738] hover:border-[#51C0C0] text-[#51C0C0] w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-300 shadow-[0_0_10px_rgba(81,192,192,0.1)] hover:shadow-[0_0_15px_rgba(81,192,192,0.3)]">
